...
SECRET_KEY = 'django-insecure-n852q=7ohnu=dp=!7i#lth!mdw)g_z&xo5%u#qe$&ex+*4e3lf'
...
MIDDLEWARE = [
    ...
    'debug_toolbar.middleware.DebugToolbarMiddleware', # Add this line to the list of middleware
]
